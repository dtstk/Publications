...
\author{R. Taranovs,~\IEEEmembership{Member,~IEEE,}
        V. Jesilevskis,
        G. Miezitis,~\IEEEmembership{Member,IEEE},
        D. Bliznjuks,~\IEEEmembership{Member,IEEE},
        E. Klavins,
        A. Kalnins,
        V. Zagursky, ~\IEEEmembership{Member,IEEE}}
...
% The paper headers
\markboth{Galveni atst. neizmant.}%
...
\bibitem{Demirbas05wirelesssenso} Murat Demirbas. Wireless Sensor Networks for Monitoring of Large Public Buildings. . p. 605--634 2005
\bibitem{szucheng}Szu-Cheng Chien, Robert Zach and Ardeshir Mahdavi, “Developing user interfaces for monitoring systems in buildings”, IADIS International Conference Interfaces and Human Computer Interaction 2011, pages 29-36, ISBN: 978-972-8939-52-6
\bibitem{bldg}BLDG services group inc., white paper “Power Monitoring in an Office Building”, 2011, p. 9, Edmonton Alberta, Canada
\bibitem{qifen}, Qifen Dong, Li Yu, Huanjia Lu, Zhen Hong, Yourong Chen, “Design of Building Monitoring Systems Based on Wireless Sensor Networks”, Wireless Sensor Network, 2010, 2, 703-709, doi:10.4236/wsn.2010.29085
\bibitem{Teodora} Teodora Trifonova, Valentina Markova, Ventseslav Draganov, KrasimiraAngelova and Vasil Dimitrov, “Smart sensor network for ergonomic evaluation of working environment”,  ICEST 2013, At Ohrid, Macedonia, Volume: vol.1 pp 371-375
\bibitem{Xbee_chip} XBee 802.15.4 - Digi International. - {\it Internet resource: http://www.digi.com/products/wireless-wired-embedded-solutions/zigbee-rf-modules/point-multipoint-rfmodules/xbee-series1-module\#overview} Accessed at 08.11.2014.
\bibitem {DHT_11} DHT11 - Humidity and Temperature Sensor [3732] Sunrom Technologies. - {\it http://www.sunrom.com/p/dht11-humidity-and-temperature-sensor} Accessed at 08.11.2014.
\bibitem {BHT_1750} Digital 16bit Serial Output Type Ambient Light Sensor IC. - {\it http://www.dfrobot.com/image/data/SEN0097/BH1750FVI.pdf} Accessed at 08.11.2014.
\bibitem {PIR_s} HC-SR501 PIR motion detector. - {\it http://www.mpja.com/download/31227sc.pdf}. Accessed at 08.11.2014.
\bibitem{IEQ} IEQ Chek, product description, online: http://www.tequipment.net/assets/1/26/Documents/Bacharach/ 1510\_0002/1510\_0002\_doc\_1.pdf, Resource Accessed on: 26.10.2014
\end{thebibliography}
