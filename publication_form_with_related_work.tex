...
\author{Romans~Taranovs~\IEEEmembership{(Riga Technical University),}
        V~Jelisevskis~\IEEEmembership{(Accenture),}
       Gundars~Miezitis~\IEEEmembership{(Riga Technical University),}
       Dmitrijs~Bliznuks~\IEEEmembership{(Riga Technical University),}
       Eriks~Klavins~\IEEEmembership{(Riga Technical University),}
       Andrejs~Kalnins~\IEEEmembership{(Riga Technical University),}
        and~Valerijs~Zagurskis~\IEEEmembership{(Riga Technical University)}% <-this % stops a space
